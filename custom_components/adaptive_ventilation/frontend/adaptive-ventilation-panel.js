...
const TEXT = {
  en: {
    ...
    profile: "Profile",
    profileHint:
      "Sets how chatty and how twitchy the system is - not how well it cools. Individual values below still win.",
    profileQuiet: "Reserved (warnings only)",
    profileBalanced: "Balanced",
    profileEager: "Attentive",
  ...
  de: {
    ...
    profile: "Profil",
    profileHint:
      "Legt fest, wie gesprächig und wie nervös das System ist - nicht, wie gut es kühlt. Einzelne Werte unten haben trotzdem Vorrang.",
    profileQuiet: "Zurückhaltend (nur Warnungen)",
    profileBalanced: "Ausgewogen",
    profileEager: "Aufmerksam",
